...
public class PictureServiceImpl implements PictureService {
	...
	@Override
	public String uploadFastDFS(MultipartFile uploadFile) {
		...
		try {
			...
			String string = fastDFSClient.uploadFile(uploadFile.getBytes(),ext);
			System.out.println(FASTDFS_URL+string);
			return FASTDFS_URL+string;
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
